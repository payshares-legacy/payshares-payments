...
var Network     = require('./payshares-network');
...
* @param {string} config.paysharesAddress The payshares account used for payouts.
* @param {string} config.paysharesSecretKey The secret key for the payshares account.
...
* @param {object} [config.database] The instantiated payshares payments database implementation.
*/
...
Payments.prototype._getLatestSequenceNumberFromNetwork = function() {
    return this.network.getAccountInfo(this.paysharesAddress)
        .then(function (result) {
