...
* @param {int|object} amount The amount of micro-stellars to send or the amount object to send (value/currency/issuer pair).
* @param {int} [amount.value] The amount of the currency to send.
