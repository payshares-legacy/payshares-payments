...
/**
* Constructs a mysql db implementation of the payshares payments interface.
...
* If isFatal, will mark that column.
*/
database.prototype.markTransactionError = function (transaction, error, isFatal) {
    var dbPromise = this.db('Transactions')
        .where({id: transaction.id})
        .update({error: error, erroredAt: new Date(), fatal: isFatal});
    return toBluebird(dbPromise);
};
 ...
 * @param {int} amount The quantity of XPR to send in Stroops.
